...
include::08_javadoc_code_snippets.adoc[]
//
//[.notes]
//--
//* https://github.com/dkandalov/tab-shifter/blob/master/src/tabshifter/layout/Split.kt
//** Use of ascii art to enhance textual documentation
//--

include::09_plain_text_documentation.adoc[]

include::10_living_diagram.adoc[]

include::11_living_glossary.adoc[]
