# mention-client-quarkus Project
...
Inspired from https://github.com/indieweb/mention-client-php
...
You can then execute your native executable with: `./target/mention-client-quarkus-1.0-SNAPSHOT-runner`
